  ...
  getReview (reviewId) {
    return this.api.pulls.get({
      ...
      .then(({base, body, head, merged, state, title}) => {
        // Log each parameter to see its value before passing to the Review constructor
        console.log('title:', title);
        console.log('body:', body);
        console.log('state:', (merged && state === 'closed') ? 'merged' : state);
        console.log('sourceBranch (head.ref):', head.ref);
        console.log('targetBranch (base.ref):', base.ref);
